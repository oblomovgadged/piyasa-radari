...
def son_canli_yayin_id_bul(kanal_url):
    try:
        ...
        req = urllib.request.Request(streams_url, headers={'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7)'})
...
def yayini_ozetle():
    ...
    try:
        ...
        ozet_verisi = { 
            ...
            "ozet": "Şu anki yayın için veri çekilemedi. YouTube geçici olarak erişimi kısıtlıyor olabilir." 
        }
